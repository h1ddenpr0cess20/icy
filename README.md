...
![Icy in a desktop browser](docs/screenshots/desktop.png)

<p align="center">
  <img src="docs/screenshots/mobile.png" alt="Icy on a phone" width="300">
</p>
...
`SSL_CERT`. Build it yourself with `docker build -t icy .`. Publishing from a
...
The log is a record. Memory is what Icy carries into the next call: a short list
of details, kept in `localStorage` under `icy.memory.v1` and appended to the
...
- [**Not a Companion**](docs/not-a-companion.md) — Icy is a toy and a demo.
