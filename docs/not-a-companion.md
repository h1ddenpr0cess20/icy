...
Icy is a toy and a technical demo: an ice cube in a glass of whiskey rendered in
three dimensions, wired to a realtime voice model, moving in time with whoever
is talking. It is explicitly **not** meant to be a companion, a friend, a
therapist, or a partner.

## Why this is written down

- **It is a bit, not a being.** The persona is a system prompt in
  `src/server/persona.js` — an ice cube that is slowly and audibly melting.
  There is nothing behind it that knows you or remembers you beyond a short list
  of details you asked it to keep.
