...
This document sets out the limits of responsibility for Icy ("the App"). It is
...
- **"App"**: the Icy client, its proxy, and the materials in this repository.
...
- The App captures microphone audio, relays it to a xAI Grok speech-to-speech
  session, and renders what comes back as an ice cube in a glass of whiskey.
