...
/**
 * Icy's voice: a queue of chunks scheduled back to back on one timeline.
 *
...
/**
 * The context both halves share, plus the output chain Icy's voice runs
 * through: gain for muting, analyser so the cube can move to its own voice.
 */
