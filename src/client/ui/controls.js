...
export function createControls({
  ...
  function sync() {
    ...
    promptEl.placeholder = connected ? 'Or type. Slower, but quieter.' : 'Tap the mic. I am not getting any bigger.';
  ...
  // Escape is barge-in for the typed path; talking over Icy is handled by the
